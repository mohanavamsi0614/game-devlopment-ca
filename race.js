...
setInterval(() => {
  ...
  block.innerHTML = "<img src='./assets/block" + random +".png' alt='' class='height'>";
}, 4000);
...
function check() {
  console.log(
    block.getBoundingClientRect().top + " " + dino.getBoundingClientRect().top
  );

  if (
    block.getBoundingClientRect().left <= dino.getBoundingClientRect().left &&
